...
func (qs CheckReservedKeywordsQuerySet) StructIn(structValue int, structValueRest ...int) CheckReservedKeywordsQuerySet {
	iArgs := []interface{}{structValue}
	for _, arg := range structValueRest {
		iArgs = append(iArgs, arg)
	}
...
// nolint: dupl
func (qs UserQuerySet) SurnameIn(surname string, surnameRest ...string) UserQuerySet {
	iArgs := []interface{}{surname}
	for _, arg := range surnameRest {
		iArgs = append(iArgs, arg)
	}
...
// nolint: dupl
func (qs UserQuerySet) SurnameNotIn(surname string, surnameRest ...string) UserQuerySet {
	iArgs := []interface{}{surname}
	for _, arg := range surnameRest {
		iArgs = append(iArgs, arg)
	}
