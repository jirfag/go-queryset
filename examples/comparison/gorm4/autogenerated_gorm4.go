...
// nolint: dupl
func (qs UserQuerySet) RatingIn(rating int, ratingRest ...int) UserQuerySet {
	iArgs := []interface{}{rating}
...
// nolint: dupl
func (qs UserQuerySet) RatingMarksIn(ratingMarks int, ratingMarksRest ...int) UserQuerySet {
	iArgs := []interface{}{ratingMarks}
...
// nolint: dupl
func (qs UserQuerySet) RatingMarksNotIn(ratingMarks int, ratingMarksRest ...int) UserQuerySet {
	iArgs := []interface{}{ratingMarks}
	for _, arg := range ratingMarksRest {
		iArgs = append(iArgs, arg)
	}
...
// nolint: dupl
func (qs UserQuerySet) RatingNotIn(rating int, ratingRest ...int) UserQuerySet {
	iArgs := []interface{}{rating}
	for _, arg := range ratingRest {
		iArgs = append(iArgs, arg)
	}
